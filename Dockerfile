# scipy-notebook version is 3.10.10 (stable at 2023/04/17).
# See also https://jupyter-docker-stacks.readthedocs.io/en/latest/using/selecting.html
# See also https://hub.docker.com/r/jupyter/scipy-notebook
FROM jupyter/scipy-notebook:python-3.10.10
